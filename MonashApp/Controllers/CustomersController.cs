...
namespace MonashApp.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            var customers = db.Customers.Where(c => c.AspNetId == AspNetId).ToList();
        ...
        {
            customer.AspNetId = User.Identity.GetUserId();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,FirstName,LastName,AspNetId,Email")] Customer customer)
        {
            if (ModelState.IsValid)
            {
